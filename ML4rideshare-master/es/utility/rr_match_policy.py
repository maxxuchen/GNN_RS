...
class RR_Match_Policy(Solution):
    def __init__(self):
        self.model = ResidualGatedGCNModel(net_config).to('cpu')
    ...
    def evaluate(self, instance):
        """
        Evaluate rr_policy with fixed vr_policy
        rr_policy: self.model, GNN model
        vr_policy: nx.algorithms.matching.max_weight_matching, heu
        :return: score of evaluation
        """
        rr_matcher = RR_Matcher('nn', self.model)
